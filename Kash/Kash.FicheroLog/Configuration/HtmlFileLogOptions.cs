namespace Kash.FicheroLog.Configuration;
...
public sealed class HtmlFileLogOptions
{
    ...
    /// <summary>
    /// Prefijo del nombre de archivo (ej: "Kash-")
    /// </summary>
    public string FileNamePrefix { get; set; } = "Kash-";
    ...
    /// </summary>
    public string PageTitle { get; set; } = "Kash - Logs del Sistema";
